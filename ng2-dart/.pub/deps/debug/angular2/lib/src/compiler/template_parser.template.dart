...
import 'expression_parser/parser.template.dart' as i9;
import 'html_ast.template.dart' as i10;
import 'html_parser.template.dart' as i11;
import 'html_tags.template.dart' as i12;
import 'identifiers.template.dart' as i13;
import 'parse_util.template.dart' as i14;
import 'provider_parser.template.dart' as i15;
import 'style_url_resolver.template.dart' as i16;
import 'template_ast.template.dart' as i17;
import 'template_preparser.template.dart' as i18;
import '../core/security.template.dart' as i19;
...
const [const [Parser], const [ElementSchemaRegistry], const [HtmlParser], const [Console]],
(Parser _exprParser, ElementSchemaRegistry _schemaRegistry, HtmlParser _htmlParser, Console _console) => new TemplateParser(_exprParser, _schemaRegistry, _htmlParser, _console))
)
;
i0.initReflector();
i1.initReflector();
